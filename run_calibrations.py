...
def make_calibration(which='hiv'):
    ...
    if which in ['syph', 'all']:
        sres += [
            ...
            'syph.n_active',
            'epi_ts.syph.prevalence_fsw',
            'epi_ts.syph.active_prevalence_fsw',
            'epi_ts.syph.prevalence_client',
            'epi_ts.syph.ever_exposed_f',
            'epi_ts.syph.ever_exposed_m',
            'epi_ts.syph.ever_exposed_fsw',
            'syph.new_treated',
