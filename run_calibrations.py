...
def make_calibration(which='hiv'):
    ...
    calib_par_dict = dict(
        hiv=dict(
            ...
            hiv_rel_init_prev=dict(low=2, high=15, guess=8, **ckw),
            hiv_rel_dur_on_art=dict(low=1.0, high=20.0, guess=8.0, **ckw),
        ),
        network=dict(
    ...
    if which in ['syph', 'all']:
        sres += [
            ...
            'syph.n_active',
            'epi_ts.syph_prevalence_fsw',
            'epi_ts.syph_active_prevalence_fsw',
            'epi_ts.syph_prevalence_client',
            ...
            'epi_ts.hiv_prev_f_15_20', 'epi_ts.hiv_prev_f_20_25', 'epi_ts.hiv_prev_f_25_30',
            'epi_ts.hiv_prev_f_30_35', 'epi_ts.hiv_prev_f_35_50', 'epi_ts.hiv_prev_f_50_65',
            'epi_ts.hiv_prev_m_15_20', 'epi_ts.hiv_prev_m_20_25', 'epi_ts.hiv_prev_m_25_30',
            'epi_ts.hiv_prev_m_30_35', 'epi_ts.hiv_prev_m_35_50', 'epi_ts.hiv_prev_m_50_65',
            'syph.new_treated',
            ...
            'transmission_by_stage.new_mtc_primary',
            'transmission_by_stage.new_mtc_secondary',
            'transmission_by_stage.new_mtc_early',
            'transmission_by_stage.new_mtc_late',
            'transmission_by_stage.new_mtc_tertiary',
            'transmission_by_stage.new_mtc_primary_death',
            'transmission_by_stage.new_mtc_primary_congenital',
            'transmission_by_stage.new_mtc_primary_normal',
            'transmission_by_stage.new_mtc_secondary_death',
            'transmission_by_stage.new_mtc_secondary_congenital',
            'transmission_by_stage.new_mtc_secondary_normal',
            'transmission_by_stage.new_mtc_early_death',
            'transmission_by_stage.new_mtc_early_congenital',
            'transmission_by_stage.new_mtc_early_normal',
            'transmission_by_stage.new_mtc_late_death',
            'transmission_by_stage.new_mtc_late_congenital',
            'transmission_by_stage.new_mtc_late_normal',
            ...
            'treatment_outcomes.kp_screen_treated',
            'treatment_outcomes.kp_screen_success',
            'treatment_outcomes.kp_screen_unnecessary',
            'treatment_outcomes.plhiv_screen_treated',
            'treatment_outcomes.plhiv_screen_success',
            'treatment_outcomes.plhiv_screen_unnecessary',
    ...
    calib = sti.Calibration(
        ...
        prune_fn=prune_fn,
        check_fn=check_fn,
        study_name=f'{LOCATION}_{which}_calibration_v21',
